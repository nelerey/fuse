...
SELECT CASE (TRIM(VARNAME))
 ...
 CASE ('swe_z01')    ; XVAR_3d = MBANDS_VAR_4d(:,:,1,1:numtim)%SWE
 CASE ('swe_z02')    ; XVAR_3d = MBANDS_VAR_4d(:,:,2,1:numtim)%SWE
 CASE ('swe_z03')    ; XVAR_3d = MBANDS_VAR_4d(:,:,3,1:numtim)%SWE
 CASE ('swe_z04')    ; XVAR_3d = MBANDS_VAR_4d(:,:,4,1:numtim)%SWE
 CASE ('swe_z05')    ; XVAR_3d = MBANDS_VAR_4d(:,:,5,1:numtim)%SWE
 CASE ('swe_z06')    ; XVAR_3d = MBANDS_VAR_4d(:,:,6,1:numtim)%SWE
 CASE ('swe_z07')    ; XVAR_3d = MBANDS_VAR_4d(:,:,7,1:numtim)%SWE
 CASE ('swe_z08')    ; XVAR_3d = MBANDS_VAR_4d(:,:,8,1:numtim)%SWE
 CASE ('swe_z09')    ; XVAR_3d = MBANDS_VAR_4d(:,:,9,1:numtim)%SWE
 CASE ('swe_z10')    ; XVAR_3d = MBANDS_VAR_4d(:,:,10,1:numtim)%SWE
 CASE ('swe_z11')    ; XVAR_3d = MBANDS_VAR_4d(:,:,11,1:numtim)%SWE
 CASE ('swe_z12')    ; XVAR_3d = MBANDS_VAR_4d(:,:,12,1:numtim)%SWE
 CASE ('swe_z13')    ; XVAR_3d = MBANDS_VAR_4d(:,:,13,1:numtim)%SWE
 CASE ('swe_z14')    ; XVAR_3d = MBANDS_VAR_4d(:,:,14,1:numtim)%SWE
 CASE ('swe_z15')    ; XVAR_3d = MBANDS_VAR_4d(:,:,15,1:numtim)%SWE
 CASE ('swe_z16')    ; XVAR_3d = MBANDS_VAR_4d(:,:,16,1:numtim)%SWE
 CASE ('swe_z17')    ; XVAR_3d = MBANDS_VAR_4d(:,:,17,1:numtim)%SWE
 CASE ('swe_z18')    ; XVAR_3d = MBANDS_VAR_4d(:,:,18,1:numtim)%SWE
 CASE ('swe_z19')    ; XVAR_3d = MBANDS_VAR_4d(:,:,19,1:numtim)%SWE
 CASE ('swe_z20')    ; XVAR_3d = MBANDS_VAR_4d(:,:,20,1:numtim)%SWE
 CASE ('swe_z21')    ; XVAR_3d = MBANDS_VAR_4d(:,:,21,1:numtim)%SWE
 CASE ('swe_z22')    ; XVAR_3d = MBANDS_VAR_4d(:,:,22,1:numtim)%SWE
 CASE ('swe_z23')    ; XVAR_3d = MBANDS_VAR_4d(:,:,23,1:numtim)%SWE
 CASE ('swe_z24')    ; XVAR_3d = MBANDS_VAR_4d(:,:,24,1:numtim)%SWE
 CASE ('swe_z25')    ; XVAR_3d = MBANDS_VAR_4d(:,:,25,1:numtim)%SWE
 CASE ('swe_z26')    ; XVAR_3d = MBANDS_VAR_4d(:,:,26,1:numtim)%SWE
 CASE ('swe_z27')    ; XVAR_3d = MBANDS_VAR_4d(:,:,27,1:numtim)%SWE
 CASE ('swe_z28')    ; XVAR_3d = MBANDS_VAR_4d(:,:,28,1:numtim)%SWE
 CASE ('swe_z29')    ; XVAR_3d = MBANDS_VAR_4d(:,:,29,1:numtim)%SWE
 CASE ('swe_z30')    ; XVAR_3d = MBANDS_VAR_4d(:,:,30,1:numtim)%SWE
 CASE ('swe_z31')    ; XVAR_3d = MBANDS_VAR_4d(:,:,31,1:numtim)%SWE
 CASE ('swe_z32')    ; XVAR_3d = MBANDS_VAR_4d(:,:,32,1:numtim)%SWE
 CASE ('swe_z33')    ; XVAR_3d = MBANDS_VAR_4d(:,:,33,1:numtim)%SWE
 CASE ('swe_z34')    ; XVAR_3d = MBANDS_VAR_4d(:,:,34,1:numtim)%SWE
 CASE ('swe_z35')    ; XVAR_3d = MBANDS_VAR_4d(:,:,35,1:numtim)%SWE
 CASE ('swe_z36')    ; XVAR_3d = MBANDS_VAR_4d(:,:,36,1:numtim)%SWE
 CASE ('swe_z37')    ; XVAR_3d = MBANDS_VAR_4d(:,:,37,1:numtim)%SWE
 CASE ('swe_z38')    ; XVAR_3d = MBANDS_VAR_4d(:,:,38,1:numtim)%SWE
 CASE ('swe_z39')    ; XVAR_3d = MBANDS_VAR_4d(:,:,39,1:numtim)%SWE
 CASE ('swe_z40')    ; XVAR_3d = MBANDS_VAR_4d(:,:,40,1:numtim)%SWE
 CASE ('swe_z41')    ; XVAR_3d = MBANDS_VAR_4d(:,:,41,1:numtim)%SWE
 CASE ('swe_z42')    ; XVAR_3d = MBANDS_VAR_4d(:,:,42,1:numtim)%SWE
 CASE ('swe_z43')    ; XVAR_3d = MBANDS_VAR_4d(:,:,43,1:numtim)%SWE
 CASE ('swe_z44')    ; XVAR_3d = MBANDS_VAR_4d(:,:,44,1:numtim)%SWE
 CASE ('swe_z45')    ; XVAR_3d = MBANDS_VAR_4d(:,:,45,1:numtim)%SWE
 CASE ('swe_z46')    ; XVAR_3d = MBANDS_VAR_4d(:,:,46,1:numtim)%SWE
 CASE ('swe_z47')    ; XVAR_3d = MBANDS_VAR_4d(:,:,47,1:numtim)%SWE
 CASE ('swe_z48')    ; XVAR_3d = MBANDS_VAR_4d(:,:,48,1:numtim)%SWE
 ...
 CASE ('snwacml_z01'); XVAR_3d = MBANDS_VAR_4d(:,:,1,1:numtim)%SNOWACCMLTN
 CASE ('snwacml_z02'); XVAR_3d = MBANDS_VAR_4d(:,:,2,1:numtim)%SNOWACCMLTN
 CASE ('snwacml_z03'); XVAR_3d = MBANDS_VAR_4d(:,:,3,1:numtim)%SNOWACCMLTN
 CASE ('snwacml_z04'); XVAR_3d = MBANDS_VAR_4d(:,:,4,1:numtim)%SNOWACCMLTN
 CASE ('snwacml_z05'); XVAR_3d = MBANDS_VAR_4d(:,:,5,1:numtim)%SNOWACCMLTN
 CASE ('snwacml_z06'); XVAR_3d = MBANDS_VAR_4d(:,:,6,1:numtim)%SNOWACCMLTN
 CASE ('snwacml_z07'); XVAR_3d = MBANDS_VAR_4d(:,:,7,1:numtim)%SNOWACCMLTN
 CASE ('snwacml_z08'); XVAR_3d = MBANDS_VAR_4d(:,:,8,1:numtim)%SNOWACCMLTN
 CASE ('snwacml_z09'); XVAR_3d = MBANDS_VAR_4d(:,:,9,1:numtim)%SNOWACCMLTN
 CASE ('snwacml_z10'); XVAR_3d = MBANDS_VAR_4d(:,:,10,1:numtim)%SNOWACCMLTN
 CASE ('snwacml_z11'); XVAR_3d = MBANDS_VAR_4d(:,:,11,1:numtim)%SNOWACCMLTN
 CASE ('snwacml_z12'); XVAR_3d = MBANDS_VAR_4d(:,:,12,1:numtim)%SNOWACCMLTN
 CASE ('snwacml_z13'); XVAR_3d = MBANDS_VAR_4d(:,:,13,1:numtim)%SNOWACCMLTN
 CASE ('snwacml_z14'); XVAR_3d = MBANDS_VAR_4d(:,:,14,1:numtim)%SNOWACCMLTN
 CASE ('snwacml_z15'); XVAR_3d = MBANDS_VAR_4d(:,:,15,1:numtim)%SNOWACCMLTN
 CASE ('snwacml_z16'); XVAR_3d = MBANDS_VAR_4d(:,:,16,1:numtim)%SNOWACCMLTN
 CASE ('snwacml_z17'); XVAR_3d = MBANDS_VAR_4d(:,:,17,1:numtim)%SNOWACCMLTN
 CASE ('snwacml_z18'); XVAR_3d = MBANDS_VAR_4d(:,:,18,1:numtim)%SNOWACCMLTN
 CASE ('snwacml_z19'); XVAR_3d = MBANDS_VAR_4d(:,:,19,1:numtim)%SNOWACCMLTN
 CASE ('snwacml_z20'); XVAR_3d = MBANDS_VAR_4d(:,:,20,1:numtim)%SNOWACCMLTN
 CASE ('snwacml_z21'); XVAR_3d = MBANDS_VAR_4d(:,:,21,1:numtim)%SNOWACCMLTN
 CASE ('snwacml_z22'); XVAR_3d = MBANDS_VAR_4d(:,:,22,1:numtim)%SNOWACCMLTN
 CASE ('snwacml_z23'); XVAR_3d = MBANDS_VAR_4d(:,:,23,1:numtim)%SNOWACCMLTN
 CASE ('snwacml_z24'); XVAR_3d = MBANDS_VAR_4d(:,:,24,1:numtim)%SNOWACCMLTN
 CASE ('snwacml_z25'); XVAR_3d = MBANDS_VAR_4d(:,:,25,1:numtim)%SNOWACCMLTN
 CASE ('snwacml_z26'); XVAR_3d = MBANDS_VAR_4d(:,:,26,1:numtim)%SNOWACCMLTN
 CASE ('snwacml_z27'); XVAR_3d = MBANDS_VAR_4d(:,:,27,1:numtim)%SNOWACCMLTN
 CASE ('snwacml_z28'); XVAR_3d = MBANDS_VAR_4d(:,:,28,1:numtim)%SNOWACCMLTN
 CASE ('snwacml_z29'); XVAR_3d = MBANDS_VAR_4d(:,:,29,1:numtim)%SNOWACCMLTN
 CASE ('snwacml_z30'); XVAR_3d = MBANDS_VAR_4d(:,:,30,1:numtim)%SNOWACCMLTN
 CASE ('snwacml_z31'); XVAR_3d = MBANDS_VAR_4d(:,:,31,1:numtim)%SNOWACCMLTN
 CASE ('snwacml_z32'); XVAR_3d = MBANDS_VAR_4d(:,:,32,1:numtim)%SNOWACCMLTN
 CASE ('snwacml_z33'); XVAR_3d = MBANDS_VAR_4d(:,:,33,1:numtim)%SNOWACCMLTN
 CASE ('snwacml_z34'); XVAR_3d = MBANDS_VAR_4d(:,:,34,1:numtim)%SNOWACCMLTN
 CASE ('snwacml_z35'); XVAR_3d = MBANDS_VAR_4d(:,:,35,1:numtim)%SNOWACCMLTN
 CASE ('snwacml_z36'); XVAR_3d = MBANDS_VAR_4d(:,:,36,1:numtim)%SNOWACCMLTN
 CASE ('snwacml_z37'); XVAR_3d = MBANDS_VAR_4d(:,:,37,1:numtim)%SNOWACCMLTN
 CASE ('snwacml_z38'); XVAR_3d = MBANDS_VAR_4d(:,:,38,1:numtim)%SNOWACCMLTN
 CASE ('snwacml_z39'); XVAR_3d = MBANDS_VAR_4d(:,:,39,1:numtim)%SNOWACCMLTN
 CASE ('snwacml_z40'); XVAR_3d = MBANDS_VAR_4d(:,:,40,1:numtim)%SNOWACCMLTN
 CASE ('snwacml_z41'); XVAR_3d = MBANDS_VAR_4d(:,:,41,1:numtim)%SNOWACCMLTN
 CASE ('snwacml_z42'); XVAR_3d = MBANDS_VAR_4d(:,:,42,1:numtim)%SNOWACCMLTN
 CASE ('snwacml_z43'); XVAR_3d = MBANDS_VAR_4d(:,:,43,1:numtim)%SNOWACCMLTN
 CASE ('snwacml_z44'); XVAR_3d = MBANDS_VAR_4d(:,:,44,1:numtim)%SNOWACCMLTN
 CASE ('snwacml_z45'); XVAR_3d = MBANDS_VAR_4d(:,:,45,1:numtim)%SNOWACCMLTN
 CASE ('snwacml_z46'); XVAR_3d = MBANDS_VAR_4d(:,:,46,1:numtim)%SNOWACCMLTN
 CASE ('snwacml_z47'); XVAR_3d = MBANDS_VAR_4d(:,:,47,1:numtim)%SNOWACCMLTN
 CASE ('snwacml_z48'); XVAR_3d = MBANDS_VAR_4d(:,:,48,1:numtim)%SNOWACCMLTN
 CASE ('snwacml_z49'); XVAR_3d = MBANDS_VAR_4d(:,:,49,1:numtim)%SNOWACCMLTN
 CASE ('snwacml_z50'); XVAR_3d = MBANDS_VAR_4d(:,:,50,1:numtim)%SNOWACCMLTN
 CASE ('snwmelt_z01'); XVAR_3d = MBANDS_VAR_4d(:,:,1,1:numtim)%SNOWMELT
 CASE ('snwmelt_z02'); XVAR_3d = MBANDS_VAR_4d(:,:,2,1:numtim)%SNOWMELT
 CASE ('snwmelt_z03'); XVAR_3d = MBANDS_VAR_4d(:,:,3,1:numtim)%SNOWMELT
 CASE ('snwmelt_z04'); XVAR_3d = MBANDS_VAR_4d(:,:,4,1:numtim)%SNOWMELT
 CASE ('snwmelt_z05'); XVAR_3d = MBANDS_VAR_4d(:,:,5,1:numtim)%SNOWMELT
 CASE ('snwmelt_z06'); XVAR_3d = MBANDS_VAR_4d(:,:,6,1:numtim)%SNOWMELT
 CASE ('snwmelt_z07'); XVAR_3d = MBANDS_VAR_4d(:,:,7,1:numtim)%SNOWMELT
 CASE ('snwmelt_z08'); XVAR_3d = MBANDS_VAR_4d(:,:,8,1:numtim)%SNOWMELT
 CASE ('snwmelt_z09'); XVAR_3d = MBANDS_VAR_4d(:,:,9,1:numtim)%SNOWMELT
 CASE ('snwmelt_z10'); XVAR_3d = MBANDS_VAR_4d(:,:,10,1:numtim)%SNOWMELT
 CASE ('snwmelt_z11'); XVAR_3d = MBANDS_VAR_4d(:,:,11,1:numtim)%SNOWMELT
 CASE ('snwmelt_z12'); XVAR_3d = MBANDS_VAR_4d(:,:,12,1:numtim)%SNOWMELT
 CASE ('snwmelt_z13'); XVAR_3d = MBANDS_VAR_4d(:,:,13,1:numtim)%SNOWMELT
 CASE ('snwmelt_z14'); XVAR_3d = MBANDS_VAR_4d(:,:,14,1:numtim)%SNOWMELT
 CASE ('snwmelt_z15'); XVAR_3d = MBANDS_VAR_4d(:,:,15,1:numtim)%SNOWMELT
 CASE ('snwmelt_z16'); XVAR_3d = MBANDS_VAR_4d(:,:,16,1:numtim)%SNOWMELT
 CASE ('snwmelt_z17'); XVAR_3d = MBANDS_VAR_4d(:,:,17,1:numtim)%SNOWMELT
 CASE ('snwmelt_z18'); XVAR_3d = MBANDS_VAR_4d(:,:,18,1:numtim)%SNOWMELT
 CASE ('snwmelt_z19'); XVAR_3d = MBANDS_VAR_4d(:,:,19,1:numtim)%SNOWMELT
 CASE ('snwmelt_z20'); XVAR_3d = MBANDS_VAR_4d(:,:,20,1:numtim)%SNOWMELT
 CASE ('snwmelt_z21'); XVAR_3d = MBANDS_VAR_4d(:,:,21,1:numtim)%SNOWMELT
 CASE ('snwmelt_z22'); XVAR_3d = MBANDS_VAR_4d(:,:,22,1:numtim)%SNOWMELT
 CASE ('snwmelt_z23'); XVAR_3d = MBANDS_VAR_4d(:,:,23,1:numtim)%SNOWMELT
 CASE ('snwmelt_z24'); XVAR_3d = MBANDS_VAR_4d(:,:,24,1:numtim)%SNOWMELT
 CASE ('snwmelt_z25'); XVAR_3d = MBANDS_VAR_4d(:,:,25,1:numtim)%SNOWMELT
 CASE ('snwmelt_z26'); XVAR_3d = MBANDS_VAR_4d(:,:,26,1:numtim)%SNOWMELT
 CASE ('snwmelt_z27'); XVAR_3d = MBANDS_VAR_4d(:,:,27,1:numtim)%SNOWMELT
 CASE ('snwmelt_z28'); XVAR_3d = MBANDS_VAR_4d(:,:,28,1:numtim)%SNOWMELT
 CASE ('snwmelt_z29'); XVAR_3d = MBANDS_VAR_4d(:,:,29,1:numtim)%SNOWMELT
 CASE ('snwmelt_z30'); XVAR_3d = MBANDS_VAR_4d(:,:,30,1:numtim)%SNOWMELT
 CASE ('snwmelt_z31'); XVAR_3d = MBANDS_VAR_4d(:,:,31,1:numtim)%SNOWMELT
 CASE ('snwmelt_z32'); XVAR_3d = MBANDS_VAR_4d(:,:,32,1:numtim)%SNOWMELT
 CASE ('snwmelt_z33'); XVAR_3d = MBANDS_VAR_4d(:,:,33,1:numtim)%SNOWMELT
 CASE ('snwmelt_z34'); XVAR_3d = MBANDS_VAR_4d(:,:,34,1:numtim)%SNOWMELT
 CASE ('snwmelt_z35'); XVAR_3d = MBANDS_VAR_4d(:,:,35,1:numtim)%SNOWMELT
 CASE ('snwmelt_z36'); XVAR_3d = MBANDS_VAR_4d(:,:,36,1:numtim)%SNOWMELT
 CASE ('snwmelt_z37'); XVAR_3d = MBANDS_VAR_4d(:,:,37,1:numtim)%SNOWMELT
 CASE ('snwmelt_z38'); XVAR_3d = MBANDS_VAR_4d(:,:,38,1:numtim)%SNOWMELT
 CASE ('snwmelt_z39'); XVAR_3d = MBANDS_VAR_4d(:,:,39,1:numtim)%SNOWMELT
 CASE ('snwmelt_z40'); XVAR_3d = MBANDS_VAR_4d(:,:,40,1:numtim)%SNOWMELT
 CASE ('snwmelt_z41'); XVAR_3d = MBANDS_VAR_4d(:,:,41,1:numtim)%SNOWMELT
 CASE ('snwmelt_z42'); XVAR_3d = MBANDS_VAR_4d(:,:,42,1:numtim)%SNOWMELT
 CASE ('snwmelt_z43'); XVAR_3d = MBANDS_VAR_4d(:,:,43,1:numtim)%SNOWMELT
 CASE ('snwmelt_z44'); XVAR_3d = MBANDS_VAR_4d(:,:,44,1:numtim)%SNOWMELT
 CASE ('snwmelt_z45'); XVAR_3d = MBANDS_VAR_4d(:,:,45,1:numtim)%SNOWMELT
 CASE ('snwmelt_z46'); XVAR_3d = MBANDS_VAR_4d(:,:,46,1:numtim)%SNOWMELT
 CASE ('snwmelt_z47'); XVAR_3d = MBANDS_VAR_4d(:,:,47,1:numtim)%SNOWMELT
 CASE ('snwmelt_z48'); XVAR_3d = MBANDS_VAR_4d(:,:,48,1:numtim)%SNOWMELT
 CASE ('snwmelt_z49'); XVAR_3d = MBANDS_VAR_4d(:,:,49,1:numtim)%SNOWMELT
 CASE ('snwmelt_z50'); XVAR_3d = MBANDS_VAR_4d(:,:,50,1:numtim)%SNOWMELT
 ! extract extrapolation errors
